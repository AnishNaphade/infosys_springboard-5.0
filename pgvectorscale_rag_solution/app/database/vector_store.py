...
class VectorStore:
    ...
    def __init__(self):
        ...
        self.openai_client = OpenAI(api_key=self.settings.openai.sk-proj-FBcQNWISYTWDBHQ6mb9uuWz_EiH9CcSceBHWA6ZmPltYxs3oCKlVpBcRWtZUrwRdemmuO6GxwT3BlbkFJGYSkjIbuJIIVGGy15xdXhEyVdFboEiwqsL4YnRlneUHZ2g9mcOTEmJsNRZLnnX52GRWiMz0fkA)
